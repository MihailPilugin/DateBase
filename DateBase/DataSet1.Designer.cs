...
namespace DateBase {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class CLIENTDataTable : global::System.Data.TypedTableBase<CLIENTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CLIENTRow AddCLIENTRow(decimal ID_CLIENT, string NAME, string EMAIL, string PHONE, string COMPANY_NAME, decimal LEGAL, string COMMENTS, string LAST_NAME) {
        ...
        public partial class CLIENTRow : global::System.Data.DataRow {
            ...
            public decimal LEGAL {
                get {
                    try {
                        return ((decimal)(this[this.tableCLIENT.LEGALColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'LEGAL\' in table \'CLIENT\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableCLIENT.LEGALColumn] = value;
                }
            }
            ...
            public bool IsLEGALNull() {
                return this.IsNull(this.tableCLIENT.LEGALColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetLEGALNull() {
                this[this.tableCLIENT.LEGALColumn] = global::System.Convert.DBNull;
            }
...
namespace DateBase.DataSet1TableAdapters {
    ...
    public partial class CLIENTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM ""MPL18"".""CLIENT"" WHERE ((""ID_CLIENT"" = :Original_ID_CLIENT) AND ((:IsNull_NAME = 1 AND ""NAME"" IS NULL) OR (""NAME"" = :Original_NAME)) AND ((:IsNull_EMAIL = 1 AND ""EMAIL"" IS NULL) OR (""EMAIL"" = :Original_EMAIL)) AND ((:IsNull_PHONE = 1 AND ""PHONE"" IS NULL) OR (""PHONE"" = :Original_PHONE)) AND ((:IsNull_COMPANY_NAME = 1 AND ""COMPANY_NAME"" IS NULL) OR (""COMPANY_NAME"" = :Original_COMPANY_NAME)) AND ((:IsNull_LEGAL = 1 AND ""LEGAL"" IS NULL) OR (""LEGAL"" = :Original_LEGAL)) AND ((:IsNull_COMMENTS = 1 AND ""COMMENTS"" IS NULL) OR (""COMMENTS"" = :Original_COMMENTS)) AND ((:IsNull_LAST_NAME = 1 AND ""LAST_NAME"" IS NULL) OR (""LAST_NAME"" = :Original_LAST_NAME)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("IsNull_COMPANY_NAME", global::System.Data.OracleClient.OracleType.Int32, 0, global::System.Data.ParameterDirection.Input, "COMPANY_NAME", global::System.Data.DataRowVersion.Original, true, null));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("Original_COMPANY_NAME", global::System.Data.OracleClient.OracleType.VarChar, 0, global::System.Data.ParameterDirection.Input, "COMPANY_NAME", global::System.Data.DataRowVersion.Original, false, null));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("IsNull_LEGAL", global::System.Data.OracleClient.OracleType.Int32, 0, global::System.Data.ParameterDirection.Input, "LEGAL", global::System.Data.DataRowVersion.Original, true, null));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("Original_LEGAL", global::System.Data.OracleClient.OracleType.Number, 0, global::System.Data.ParameterDirection.Input, "LEGAL", global::System.Data.DataRowVersion.Original, false, null));
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("Original_COMMENTS", global::System.Data.OracleClient.OracleType.VarChar, 0, global::System.Data.ParameterDirection.Input, "COMMENTS", global::System.Data.DataRowVersion.Original, false, null));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"MPL18\".\"CLIENT\" (\"ID_CLIENT\", \"NAME\", \"EMAIL\", \"PHONE\", \"COMPANY_NAM" +
                "E\", \"LEGAL\", \"COMMENTS\", \"LAST_NAME\") VALUES (:ID_CLIENT, :NAME, :EMAIL, :PHONE," +
                " :COMPANY_NAME, :LEGAL, :COMMENTS, :LAST_NAME)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("COMPANY_NAME", global::System.Data.OracleClient.OracleType.VarChar, 0, global::System.Data.ParameterDirection.Input, "COMPANY_NAME", global::System.Data.DataRowVersion.Current, false, null));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("LEGAL", global::System.Data.OracleClient.OracleType.Number, 0, global::System.Data.ParameterDirection.Input, "LEGAL", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""MPL18"".""CLIENT"" SET ""ID_CLIENT"" = :ID_CLIENT, ""NAME"" = :NAME, ""EMAIL"" = :EMAIL, ""PHONE"" = :PHONE, ""COMPANY_NAME"" = :COMPANY_NAME, ""LEGAL"" = :LEGAL, ""COMMENTS"" = :COMMENTS, ""LAST_NAME"" = :LAST_NAME WHERE ((""ID_CLIENT"" = :Original_ID_CLIENT) AND ((:IsNull_NAME = 1 AND ""NAME"" IS NULL) OR (""NAME"" = :Original_NAME)) AND ((:IsNull_EMAIL = 1 AND ""EMAIL"" IS NULL) OR (""EMAIL"" = :Original_EMAIL)) AND ((:IsNull_PHONE = 1 AND ""PHONE"" IS NULL) OR (""PHONE"" = :Original_PHONE)) AND ((:IsNull_COMPANY_NAME = 1 AND ""COMPANY_NAME"" IS NULL) OR (""COMPANY_NAME"" = :Original_COMPANY_NAME)) AND ((:IsNull_LEGAL = 1 AND ""LEGAL"" IS NULL) OR (""LEGAL"" = :Original_LEGAL)) AND ((:IsNull_COMMENTS = 1 AND ""COMMENTS"" IS NULL) OR (""COMMENTS"" = :Original_COMMENTS)) AND ((:IsNull_LAST_NAME = 1 AND ""LAST_NAME"" IS NULL) OR (""LAST_NAME"" = :Original_LAST_NAME)))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("COMPANY_NAME", global::System.Data.OracleClient.OracleType.VarChar, 0, global::System.Data.ParameterDirection.Input, "COMPANY_NAME", global::System.Data.DataRowVersion.Current, false, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("LEGAL", global::System.Data.OracleClient.OracleType.Number, 0, global::System.Data.ParameterDirection.Input, "LEGAL", global::System.Data.DataRowVersion.Current, false, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("COMMENTS", global::System.Data.OracleClient.OracleType.VarChar, 0, global::System.Data.ParameterDirection.Input, "COMMENTS", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("IsNull_COMPANY_NAME", global::System.Data.OracleClient.OracleType.Int32, 0, global::System.Data.ParameterDirection.Input, "COMPANY_NAME", global::System.Data.DataRowVersion.Original, true, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("Original_COMPANY_NAME", global::System.Data.OracleClient.OracleType.VarChar, 0, global::System.Data.ParameterDirection.Input, "COMPANY_NAME", global::System.Data.DataRowVersion.Original, false, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("IsNull_LEGAL", global::System.Data.OracleClient.OracleType.Int32, 0, global::System.Data.ParameterDirection.Input, "LEGAL", global::System.Data.DataRowVersion.Original, true, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("Original_LEGAL", global::System.Data.OracleClient.OracleType.Number, 0, global::System.Data.ParameterDirection.Input, "LEGAL", global::System.Data.DataRowVersion.Original, false, null));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OracleClient.OracleParameter("Original_COMMENTS", global::System.Data.OracleClient.OracleType.VarChar, 0, global::System.Data.ParameterDirection.Input, "COMMENTS", global::System.Data.DataRowVersion.Original, false, null));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DateBase.Properties.Settings.Default.ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_CLIENT, NAME, EMAIL, PHONE, COMPANY_NAME, LEGAL, COMMENTS, LAST_NAME FR" +
                "OM MPL18.CLIENT";
        ...
        public virtual int Delete(decimal Original_ID_CLIENT, string Original_NAME, string Original_EMAIL, string Original_PHONE, string Original_COMPANY_NAME, global::System.Nullable<decimal> Original_LEGAL, string Original_COMMENTS, string Original_LAST_NAME) {
            ...
            if ((Original_LEGAL.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[9].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[10].Value = ((decimal)(Original_LEGAL.Value));
            }
            else {
        ...
        public virtual int Insert(decimal ID_CLIENT, string NAME, string EMAIL, string PHONE, string COMPANY_NAME, global::System.Nullable<decimal> LEGAL, string COMMENTS, string LAST_NAME) {
            ...
            if ((LEGAL.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((decimal)(LEGAL.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string PHONE, 
                    string COMPANY_NAME, 
                    global::System.Nullable<decimal> LEGAL, 
                    string COMMENTS, 
                    string LAST_NAME, 
                    ...
                    global::System.Nullable<decimal> Original_LEGAL, 
            ...
            if ((LEGAL.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((decimal)(LEGAL.Value));
            }
            else {
            ...
            if ((Original_LEGAL.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((decimal)(Original_LEGAL.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NAME, string EMAIL, string PHONE, string COMPANY_NAME, global::System.Nullable<decimal> LEGAL, string COMMENTS, string LAST_NAME, decimal Original_ID_CLIENT, string Original_NAME, string Original_EMAIL, string Original_PHONE, string Original_COMPANY_NAME, global::System.Nullable<decimal> Original_LEGAL, string Original_COMMENTS, string Original_LAST_NAME) {
            return this.Update(Original_ID_CLIENT, NAME, EMAIL, PHONE, COMPANY_NAME, LEGAL, COMMENTS, LAST_NAME, Original_ID_CLIENT, Original_NAME, Original_EMAIL, Original_PHONE, Original_COMPANY_NAME, Original_LEGAL, Original_COMMENTS, Original_LAST_NAME);
        }
    }
